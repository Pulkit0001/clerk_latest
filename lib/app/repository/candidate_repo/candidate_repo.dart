...
abstract class CandidateRepo{
  ...
  Future<Either<List<Candidate>, String>> getAllCandidates({List<String>? candidateIds});

  Future<Either<List<String>, String>> searchCandidates({required String searchQuery});
  ...
  Future<Either<bool, String>> changeGroup({required String candidateId,required String groupId});

  Future<Either<bool, String>> applyCharges({required String candidateId,required List<String> chargeIds});

  Future<Either<bool, String>> removeCharges({required String candidateId,required List<String> chargeIds});
